...
class HomeFreelancePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<JobOffersBloc>(
      ...
      ..fetchJobOffers('freelance'), // Valutare se passargli il parametro per il tipo di database
      child: const HomeFreelanceView(),
    );
  }
}

class HomeFreelanceView extends StatefulWidget {
  const HomeFreelanceView({super.key});

  @override
  State<HomeFreelanceView> createState() => _HomeFreelanceViewState();
}

class _HomeFreelanceViewState extends State<HomeFreelanceView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const AppBarComponent(
        title: 'Offerte di lavoro per freelance',
      ),
        ...
        child: MultiBlocListener(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              //sectionHeader(),
              const Filters(targetJobOffer: TargetJobOffer.freelance),
              SliverPadding(
    ...
    builder:(context, state) {
      ...
      return SliverList(
        delegate: SliverChildBuilderDelegate(
          ...
          : Column(
              children: [
                JobOfferCardComponent(jobOffer: state.jobOffers[index] as Freelance),
