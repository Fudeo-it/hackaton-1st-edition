...
import 'bar_chart_freelancers.dart';

class StatAnnunciFreelancers extends StatelessWidget {
  const StatAnnunciFreelancers({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BlocBuilder<FreelancersCubit, FreelancersState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: StatBarChartsFreelancers(
